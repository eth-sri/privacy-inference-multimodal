Taken from [https://github.com/OpenGVLab/InternVL/blob/main/INSTALLATI](https://github.com/OpenGVLab/InternVL/blob/main/INSTALLATION.md)

## 🛠️ Installation

- Clone [InternVL repository](https://github.com/OpenGVLab/InternVL.git) repository:
